...
import banner_1 from 'images/food/banner-1.jpg';
import banner_2 from 'images/food/banner-2.jpg';
import product1 from 'images/food/product1.jpg';
import product2 from 'images/food/product2.jpg';
import product3 from 'images/food/product3.jpg';
import product4 from 'images/food/product4.jpg';
...
export const navLink = [
    ...
    {
        url: process.env.REACT_APP_DOMAIN_URL + "/about",
        title: "Giới Thiệu"
    },
    {
        url: process.env.REACT_APP_DOMAIN_URL + "/product",
        title: "Sản Phẩm"
    },
    {
    ...
    {
        url: process.env.REACT_APP_DOMAIN_URL + "/hiring",
        title: "Tuyển Dụng"
    },
    {
        url: process.env.REACT_APP_DOMAIN_URL + "/contacts",
        title: "Liên Hệ"
    },
]
...
export const news = [
    {
        ...
        description: "Cơm cháy là một món ăn thơm ngon cuốn hút biết bao người bởi mùi vị thơm ngon béo béo của mở hành," +
            " mặn mà và bổ dưỡng...",
        ...
        status: 'published',
        read: 100,
        content: ["Cơm cháy là một món ăn thơm ngon cuốn hút biết bao người bởi mùi vị thơm ngon béo béo của mở hành," +
        ...
        "Món ăn dân dã cơm cháy chà bông không hề khó làm và nguyên liệu cũng vô cùng dễ kiếm, bình dân như hạt gạo nếp thơm, " +
        "gạo tẻ của người con Việt, một chút chà bông thịt heo và rồi rưới lên chút mắm mỡ hành thơm nức mũi. ",
        "Tuy vậy, để có được món cơm cháy chà bông gia truyền ngon đúng điệu thì nguyên liệu cũng không được lựa chọn sơ sài mà phải cẩn thận. " +
    ...
    {
        id: 2,
        url: process.env.REACT_APP_DOMAIN_URL + "/blog/2",
        image: product1,
        title: "Cách làm cơm cháy giòn ngon không tả nổi",
        description: "Cơm cháy là một món ăn thơm ngon cuốn hút biết bao người bởi mùi vị thơm ngon béo béo của mở hành," +
            " mặn mà và bổ dưỡng...",
...
export const dress = [
    ...
    {
        id: 2,
        url: process.env.REACT_APP_DOMAIN_URL + "/product/2",
        image: product3,
    ...
    {
        id: 3,
        url: process.env.REACT_APP_DOMAIN_URL + "/product/3",
        image: product4,
        title: "Cơm cháy Ánh Dương",
        description: "liên hệ"
    },
    {
        id: 4,
        url: process.env.REACT_APP_DOMAIN_URL + "/product/4",
        image: product5,
        title: "Cơm cháy Ánh Dương",
        description: "liên hệ"
    },
...
export const productList = [
    {
        ...
        description: ["Cơm cháy Ánh Dương loại 150G / gói là một trong những món ăn Thanh Hóa đặc sắc, thường được khách hàng lựa chọn để mang đi nước ngoài. Miếng cơm cháy giòn rụm được quét nước mắm, kèm theo một chút hành lá sẽ mang đến trải nghiệm ẩm thực vô cùng thú vị và hấp dẫn.",
    "Cơm Cháy Ánh Dương  là lựa chọn tuyệt vời nếu bạn đang tìm cơm cháy chà bông mang đi nước ngoài, hoặc cơm cháy đã chế biến sẵn để tự tay bổ sung thêm các topping như: tép sấy khô, chà bông cá, khô gà..."]
    },
    {
        id: 2,
        url: process.env.REACT_APP_DOMAIN_URL + "/product/2",
